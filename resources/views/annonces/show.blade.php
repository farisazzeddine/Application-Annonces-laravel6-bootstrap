...
<div class="jumbotron text-left">
    ...
    <div class="container">
            ...
            <div class="details_image_large"><img src="/storage/{{$annonces->image1}}" width="400" alt=""><div class="product_extra product_new"><br></div></div>
     ...
     <div class="details_image_thumbnail active" data-image="/storage/{{$annonces->image1}}"><img src="/storage/{{$annonces->image1}}" width="100" alt=""></div>
            ...
            <div><a href="">{{$annonces ->category->category}}</a></div>
            </div>
            </div>
            ...
            <div class="in_stock_container">
                    ...
                    <h1 class="text-uppercase font-weight-bold">{{$annonces ->title}}</h1>
            ...
            <div class="details_discount"><p class="font-weight-bold">PRIX: <span class="font-weight-light">{{$annonces ->price}}</span> DHs </p></div>
            </div>
            </div>


            <div class="product_quantity_container">
                    <p class="text-capitalize font-weight-bold">Ville: <span class="font-weight-light text-uppercaset ">{{$annonces ->city->city}}<span></p>
            <div class="product_quantity clearfix">
                    <p class="text-capitalize font-weight-bold">Numéro de téléphone:<span class="font-weight-light"> {{$annonces ->user->phone}}<span></p>
